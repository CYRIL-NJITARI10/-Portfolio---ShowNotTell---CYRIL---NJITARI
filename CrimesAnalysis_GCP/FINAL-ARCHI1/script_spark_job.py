...
result_q1 = df_filtered.groupBy(month(col("Date")).alias("Month")) \
                       ...
                       .orderBy("Month")
result_q1.show()
result_q1.write.mode("overwrite").parquet(base_path + "question1_output.parquet")
...
result_q2.write.mode("overwrite").parquet(base_path + "question2_output.parquet")
...
result_q3 = df.groupBy(year(col("Date")).alias("Year")) \
              ...
              .orderBy("Year")
result_q3.show()
result_q3.write.mode("overwrite").parquet(base_path + "question3_output.parquet")
...
result_q4.show()
result_q4.write.mode("overwrite").parquet(base_path + "question4_output.parquet")
...
result_q5.show()
result_q5.write.mode("overwrite").parquet(base_path + "question5_output.parquet")
